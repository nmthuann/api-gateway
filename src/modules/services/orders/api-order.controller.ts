...
import { CreateOrderInterceptor } from 'src/interceptors/create-order.interceptor'
...
export class ApiGatewayOrderController {
  constructor(private readonly apiGatewayOrderService: ApiGatewayOrderService) {}
